...
const PagesHeader = ({ image, title }) => {
  ...
  return (
    <div
      ...
      data-aos-delay="10"
      style={config}
      className="md:h-[400px] w-full h-[300px]"
    >
      <div className=" bg-black/[0.5] w-full h-full flex justify-center items-center">
        <div className="px-3 pt-8 md:p-0">
          <h1
            ...
            className="font-bold md:text-5xl text-3xl tracking-[5px] text-white md:mb-5 mb-4 text-center"
          >
